...
> **역사 자료 — 현재 구현의 리뷰·운영 지시가 아닙니다.** 아래는 PR #68 원본 `0b978e0`에 포함된 당시 프롬프트입니다. 기본 ON·revoked 재발급·원장/비교 결함 때문에 실행 구현과 구형 테스트는 #67/#70으로 대체했습니다. 현재 리뷰에는 [Toss 런타임 리뷰 프롬프트](toss-runtime-review-2026-09-16.md)를 사용하고, [2026-09-17 정합화 보고서](../toss-pr-integration-2026-09-17.md)를 먼저 확인하십시오. 아래 파일·SHA·명령·완료 주장은 원본 당시 범위에만 해당합니다.
