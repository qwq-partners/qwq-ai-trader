...
> 후속 사용자 결정: **기존 거래 봇을 유지하는 별도 관측 서비스 방식**을 선택했다. 아래 선택 대기 문구는 당시 기록이다. [새 상세 설계](../superpowers/specs/2026-09-17-toss-observer-service-design.md)에 단일 발급·추가 KIS0·보유 종목 관측·실행 신뢰 경계를 정리했으며, 아직 구현/설치/ON은 하지 않았다.
