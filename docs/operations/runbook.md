...
- 2026-09-15 교차 리뷰 후속: 거래일 08:00 이전 장외 수면은 **08:00까지 남은 초로 제한**한다(07:59→60초, 07:59:59→1초). 수면 직전 실제 시각 기준이며 300초 대기가 프리장 주문 시작을 넘지 않는다. 정상 장중 30초·휴장일 300초 정책은 유지한다. 아직 로컬 수정본이며 별도 리뷰·배포 승인이 필요하다.
