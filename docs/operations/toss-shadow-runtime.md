...
상태: 오프라인 구현·검증/독립 소스 리뷰 완료([검증 원장](../reviews/toss-runtime-2026-09-16.md)). #70/#68 정합화 통합본은 09-17 배포됐으나 Toss는 OFF다([배포 기록](../reviews/toss-pr-integration-2026-09-17.md)). 사용자는 별도 관측 서비스를 선택했으며 [후속 설계](../superpowers/specs/2026-09-17-toss-observer-service-design.md)는 상세 확인 전이다. 아직 독립 서비스·launcher·실제 승인 파일을 설치하거나 활성화하지 않았다.
