...
### Reviews (리뷰)
- [KR 실행 안전성 후속 Plan–Do–See](reviews/engine-execution-followup-2026-09-18.md) — broker 조회·경제/보호/일자/R·요청/예약·계좌 lease/종료 drain·시세 원관측 한정 리뷰, KST/UTC3544시험. 실제 위험 writer·callback/설치·전체 인수·미입증 공식 증거는 잔여
