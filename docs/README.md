...
- [S3 세부 계획 — SIGNAL→gateway→owner prepare/dispatch](superpowers/plans/2026-09-21-s3-signal-gateway.md) — 조사 확정 사실 19·coordinator 결정 17건(적대적 심사 must-fix 8건 수용)·계약 8·하위 단계 S3-1~S3-6b 의 고정 인터페이스/RED/변이·legacy/US 불변 증명·S4/S5/10A3/10C 로 미룬 것. **계획이며 구현 아님**
