...
> 2026-09-17 후속: 아래는 구현 당시의 동일 봇 프로세스 설계다. 사용자 선택에 따른 **별도 관측 서비스 배치**는 [새 설계](2026-09-17-toss-observer-service-design.md)에서 다룬다(상세 설계 확인 전·설치/ON 미실행). 기존 인증/원장 안전 계약은 보존한다. #68 보류 등 당시 Git 상태는 [후속 병합/배포 기록](../../reviews/toss-pr-integration-2026-09-17.md)으로 대체된다.
