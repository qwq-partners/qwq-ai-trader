...
- 배포·재기동은 사용자 최종 지시 범위에서 별도 실행(결과는 `docs/reviews/remediation-2026-09-14.md` §11.8). 상세: 같은 문서 §11, `docs/superpowers/plans/2026-09-13-review-remediation.md` T10 절.
