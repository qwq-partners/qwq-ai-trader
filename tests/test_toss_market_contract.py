...
def test_parse_prices_does_not_let_bad_duplicate_replace_first_valid_row():
    quotes = parse_prices(
        {"result": [_price_row(price="105"), _price_row(price="NaN")]},
...
@pytest.mark.parametrize(
    ("timestamp", "status"),
    [
        ("2026-09-16T10:01:00+09:00", "stale"),
